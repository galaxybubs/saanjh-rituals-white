        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <div className="flex flex-col items-center leading-none -space-y-2">
              <span className="font-heading text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#FFE680] via-[#D4AF37] to-[#6B5014] bg-clip-text text-transparent" style={{
              ...
              <span className="font-heading text-xs md:text-sm font-light tracking-[0.15em] bg-gradient-to-r from-[#B8860B] via-[#8B6914] to-[#5C4033] bg-clip-text text-transparent" style={{
                textShadow: '0 1px 4px rgba(0, 0, 0, 0.4), 0 0 12px rgba(139, 105, 20, 0.2)',
                filter: 'drop-shadow(0 0.5px 2px rgba(0, 0, 0, 0.3))',
                WebkitTextStroke: '0.2px rgba(92, 64, 51, 0.15)'
              }}>
                RITUALS
              </span>
            </div>

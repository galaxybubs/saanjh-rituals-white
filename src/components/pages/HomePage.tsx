...
export default function HomePage() {
  ...
  return (
      <div className="min-h-screen bg-warm-cream text-foreground font-paragraph overflow-clip selection:bg-primary/30 selection:text-foreground" style={{ paddingBottom: '64px' }}>
          ...
          <section id="29386f1f-37ac-40cb-b88a-26d0b09baf9a" className="md:px-12 bg-warm-cream relative overflow-hidden py-[22px] px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-2">
                        ...
                        <AnimatedElement delay={600} className="mt-0">
                            <div className="bg-gradient-to-r from-primary/5 to-secondary/5 border-l-4 border-primary rounded-lg backdrop-blur-sm p-8 py-6 px-8 my-[25px] mx-0 mt-[45px] mr-0 mb-[25px] ml-0">
          ...
          {/* --- PRODUCT SHOWCASE: IMMERSIVE COLLECTION --- */}
                        ...
                        return (
                            <AnimatedElement key={blend._id} delay={index * 100} className="group">
                                <Link to="/store" className="block">
                                    ...
                                    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-warm-cream via-white to-soft-rose-beige/30 border border-primary/15 p-4 transition-all duration-700 group-hover:border-primary/30 group-hover:shadow-lg group-hover:shadow-primary/10 backdrop-blur-sm min-h-[120px] flex flex-col py-6 px-4">
          ...
          <section className="py-32 overflow-hidden bg-dark-herbal-green overflow-hidden">
              <div className="max-w-[120rem] mx-auto px-6 mb-16 flex justify-between items-end">
                ...
                <Reveal delay={200} className="hidden md:block">
                  <p className="text-soft-rose-beige max-w-md text-right text-sm mt-0 mr-0 mb-[65px] ml-0">
